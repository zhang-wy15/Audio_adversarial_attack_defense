...
if __name__ == '__main__':
    ...
    denoiser = DAE()
    denoiser.load_state_dict(torch.load('./models/denoiser_deepspeech_final.pth'))
    ...
    for i, (data) in tqdm(enumerate(test_loader), total=len(test_loader)):
        ...
        for size in target_sizes:
            ...
            offset += size
        adv_out = denoiser(inputs)
        _, out, output_sizes = model(adv_out, input_sizes)
